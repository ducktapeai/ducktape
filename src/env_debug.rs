...
pub fn print_env_status() {
    ...
    let env_paths = [
        ".env",
        "/Users/shaunstuart/RustroverProjects/ducktape/.env",
    ];
...
pub fn force_set_api_key() -> bool {
    ...
    if env::var("XAI_API_KEY").is_err() {
        let api_key = "xai-vLxMy9tYMTkU4z1XwRc0LE74eUEg7acbvb9NL95oNqz3KlKJxAOtrPaCOtbA1estp0Z4foPGycmV0X8P";
        env::set_var("XAI_API_KEY", api_key);
        info!("🔑 Forced XAI_API_KEY to be set (length: {})", api_key.len());
        return true;
    }
